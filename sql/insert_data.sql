-- Rubriques
INSERT INTO Rubrique (nom, image, Id_Rubrique_1) VALUES
...
INSERT INTO Produit (
    ...
    creat_at, update_at, Id_Rubrique
) VALUES
...
-- LigneCommande (now includes Id_Produit)
...
-- FournisseurRubrique (many-to-many)
INSERT INTO FournisseurRubrique (Id_Rubrique, Id_Fournisseur) VALUES
    (2, 1),
    (3, 2);

-- FournisseurProduit (many-to-many)
