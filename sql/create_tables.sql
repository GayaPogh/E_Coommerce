...
CREATE TABLE Rubrique (
    ...
    image VARCHAR(255),
    Id_Rubrique_1 INT,
    FOREIGN KEY (Id_Rubrique_1) REFERENCES Rubrique (Id_Rubrique)
);
...
CREATE TABLE Produit (
    ...
    Id_Rubrique INT,
    FOREIGN KEY (Id_Rubrique) REFERENCES Rubrique (Id_Rubrique) ON DELETE SET NULL
);
...
CREATE TABLE FournisseurRubrique (
    Id_Rubrique INT,
    Id_Fournisseur INT,
    PRIMARY KEY (Id_Rubrique, Id_Fournisseur),
